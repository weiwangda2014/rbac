...
public class SendMailUtil {
    ...
    private static final String from = "wong_kui@163.com";
    private static final String fromName = "石林正欣禽业有限公司";
    private static final String charSet = "utf-8";
    private static final String username = "wong_kui@163.com";
    private static final String password = "wongdawei332500";
    ...
    static {
        ...
        // qq
        hostMap.put("smtp.qq", "smtp.exmail.qq.com");
    ...
    public static void main(String[] args) {
        ...
        sendCommonMail("1379948517@qq.com", "ddd", "message");
