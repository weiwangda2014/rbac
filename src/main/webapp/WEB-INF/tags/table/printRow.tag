...
<button class="btn btn-sm" data-toggle="tooltip" data-placement="left" onclick="print()" title="打印"><i
        class="fa fa-print"></i> ${label==null?'打印':label}</button>
</button>
<printRow>
    ...
    <script type="text/javascript">
        ...
        function print() {
            ...
            var sn = $("#${id} tbody tr td input.i-checks:checkbox:checked").attr("sn");
            openDialogView('${title}', "${url}?sn=" + sn, "${width==null?'800px':width}", "${height==null?'500px':height}");
        }
    </script>
</printRow>