package com.wandun.modules.monitor.utils;
...
public class SystemInfo {
    ...
    public static Map usage(Sigar sigar) {
        ...
        try {
            ...
            double b = 0.0;
            for (Map m : cpu) b += Double.parseDouble(m.get("cpuTotal") + "");
    ...
    public static List<Map> cpuInfos(Sigar sigar) {
        List<Map> monitorMaps = new ArrayList<>();
        try {
        ...
        for (FileSystem fileSystem : fslist) {
            ...
            switch (fileSystem.getType()) {
                ...
                case 2: // TYPE_LOCAL_DISK : 本地硬盘
                    ...
                    // 文件系统总大小
                    monitorMap.put("diskTotal", fileSystem.getSysTypeName());
                    // 文件系统剩余大小
