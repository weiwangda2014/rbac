...
<table  class="table table-bordered table-hover">
    ...
    <tr>
        ...
        <td class="width-35"><form:hidden id="nameImage" path="photo" htmlEscape="false" maxlength="255"
                                          class="input-xlarge"/>
        ...
        <td class="width-35"><sys:treeselect id="company" name="company.id" value="${user.company.id}"
    ...
    <tr>
        ...
        <td><sys:treeselect id="office" name="office.id" value="${user.office.id}" labelName="office.name"
        ...
        <td><form:input path="no" htmlEscape="false" maxlength="50" class="form-control required"
                        autocomplete="off"/></td>
    </tr>

    <tr>
        <td class="active"><label class="pull-right"><font color="red">*</font>姓名:</label></td>
        <td><form:input path="name" htmlEscape="false" maxlength="50" class="form-control required"
                        autocomplete="off"/></td>
    ...
    <tr>
        <td class="active"><label class="pull-right"><c:if test="${empty user.id}"><font color="red">*</font></c:if>密码:</label>
        </td>
        ...
        <td class="active">
            <label class="pull-right"><c:if test="${empty user.id}"><font color="red">*</font></c:if>确认密码:</label>
        </td>
        <td><input id="confirmNewPassword" name="confirmNewPassword" type="password"
                   class="form-control ${empty user.id?'required':''}" value="" maxlength="50" minlength="3"/></td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <form:select path="education" items="${fns:getDictList('education_type')}" class="form-control"
                         itemLabel="label" itemValue="value" htmlEscape="false"></form:select>
        </td>
        <td class="active"><label class="pull-right">身份证号:</label></td>
        <td><form:input path="carded" htmlEscape="false" maxlength="100" class="form-control" autocomplete="off"/></td>
    </tr>

    <tr>
        <td class="active"><label class="pull-right">家庭住址:</label></td>
        <td><form:input path="address" htmlEscape="false" maxlength="100" class="form-control" autocomplete="off"/></td>
        <td class="active"><label class="pull-right">入职时间:</label></td>
        <td><form:input path="thetime" htmlEscape="false" maxlength="100" class="form-control" autocomplete="off"/></td>
    </tr>
    ...
    <tr>
        ...
        <td><span class="lbl">IP: ${user.loginIp}&nbsp;&nbsp;&nbsp;&nbsp;时间：<fmt:formatDate value="${user.loginDate}"
                                                                                            type="both"
                                                                                            dateStyle="full"/></span>
        </td>
    </tr>
