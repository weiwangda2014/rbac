...
<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
    ...
    <table  class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td class="width-35"><form:input path="sort" htmlEscape="false" maxlength="50"
        ...
        <tr>
            ...
            <td class="width-35"><form:radiobuttons path="isShow" items="${fns:getDictList('show_hide')}"
            ...
            <td class="width-35"><form:input path="permission" htmlEscape="false" maxlength="100"
                                             class="form-control "/>
