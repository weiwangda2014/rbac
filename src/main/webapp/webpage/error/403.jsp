...
%>
<%@page import="com.wandun.common.utils.Exceptions" %>
<%@page import="com.wandun.common.utils.StringUtils" %>
<%@page import="com.wandun.common.web.Servlets" %>
...
<div class="container-fluid">
    ...
    <%
        if (ex != null && StringUtils.startsWith(ex.getMessage(), "msg:")) {
            out.print("<div>" + StringUtils.replace(ex.getMessage(), "msg:", "") + "</div>");
        }
    %>
