...
public class ExpandTagRuleBundle implements TagRuleBundle {
    ...
    private static final String TAG_addRow = "addRow";
    ...
    private static final String TAG_delRow = "delRow";
    private static final String TAG_editRow = "editRow";
    private static final String TAG_exportExcel = "exportExcel";
    private static final String TAG_importExcel = "importExcel";
