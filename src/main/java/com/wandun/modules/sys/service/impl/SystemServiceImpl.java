...
import com.wandun.common.security.Digests;
import com.wandun.common.security.shiro.session.SessionDAO;
import com.wandun.common.service.ServiceException;
import com.wandun.common.service.impl.BaseServiceImpl;
import com.wandun.common.utils.CacheUtils;
import com.wandun.common.utils.Encodes;
import com.wandun.common.utils.StringUtils;
import com.wandun.modules.sys.dao.MenuDao;
import com.wandun.modules.sys.dao.RoleDao;
...
/*    @Autowired
    ...
    public Page<User> findUser(Page<User> page, User user) {
        ...
        user.getSqlMap().put("dsf", BaseServiceImpl.dataScopeFilter(user.getCurrentUser(), "o", "a"));
        // 设置分页参数
        user.setPage(page);
        // 执行分页查询
...
//		systemRealm.clearAllCachedAuthorizationInfo();
    ...
    @Override
    public void deleteMenus(List<String> menus) {
