...
import com.wandun.modules.sys.dao.*;
import com.wandun.modules.sys.entity.*;
...
public class UserUtils {
    ...
    public static String getTime(Date date) {
        ...
        if (date != null) {
            Date d1 = new Date();
            Interval interval = new Interval(d1.getTime(), date.getTime());
            ...
            if (days > 0) {
                time.append(p.getDays() + "天");
            }

            if (hours > 0) {
                time.append(p.getHours() + "小时");
            }
            if (minutes > 0) {
                time.append(p.getMinutes() + "分钟");
            }
